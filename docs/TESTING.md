...
6. проверить основной и альтернативный hotkey;
7. проверить историю и повторную вставку;
8. сменить input device;
9. выполнить sleep/wake и повторить диктовку;
10. выключить сеть и убедиться, что локальная диктовка продолжает работать;
11. включить AI cleanup только с тестовым текстом и проверить raw fallback;
12. перезапустить агент из control panel.
